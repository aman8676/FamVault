// components/DocumentsSection.jsx
    ...
    <section>
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">
            {documents.length} file{documents.length !== 1 ? "s" : ""} · encrypted
          </p>
        </div>
        <button
          onClick={onUpload}
          className="inline-flex items-center gap-2.5 px-5 py-3 rounded-xl bg-indigo-600 dark:bg-indigo-500 hover:bg-indigo-700 dark:hover:bg-indigo-600 text-white text-sm font-bold transition-colors shadow-lg shadow-indigo-500/20"
        >
      ...
      <div className="relative mb-4">
        ...
        <input
          ...
          className="w-full pl-11 pr-11 py-3 rounded-xl border border-gray-200 dark:border-white/[0.1] bg-white dark:bg-white/[0.06] text-sm text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500
            focus:outline-none focus:ring-2 focus:ring-indigo-500/20 dark:focus:ring-indigo-500/30 focus:border-indigo-400 dark:focus:border-indigo-500/50 transition-all"
        />
        {searchQuery && (
          <button
            ...
            <div className="flex flex-wrap gap-2.5 p-4 rounded-xl bg-gray-50 dark:bg-white/[0.04] border border-gray-100 dark:border-white/[0.06]">
              ...
              {allTags.map((tag) => (
                <button
                  ...
                  className="px-3 py-1.5 rounded-lg text-xs bg-white dark:bg-white/[0.06] border border-gray-200 dark:border-white/[0.1] text-gray-600 dark:text-gray-400 hover:border-indigo-300 dark:hover:border-indigo-500/40 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors font-medium"
                >
                  #{tag}
                </button>
              ))}
      ...
      {hasFilters && (
        <div className="flex items-center gap-2 mb-5 text-xs text-gray-500 dark:text-gray-400">
          ...
          <button
            ...
            className="text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 dark:hover:text-indigo-300 underline underline-offset-2 font-semibold"
          >
            Clear all
          </button>
        </div>
      ...
      {documentsLoading ? (
        ...
        <div className="flex flex-col items-center justify-center py-20 rounded-2xl border-2 border-dashed border-gray-200 dark:border-white/[0.1] bg-gray-50/50 dark:bg-white/[0.02]">
          <div className="w-16 h-16 rounded-2xl bg-indigo-50 dark:bg-indigo-500/15 flex items-center justify-center mb-5">
          ...
          <button
            onClick={onUpload}
            className="inline-flex items-center gap-2.5 px-6 py-3 rounded-xl bg-indigo-600 dark:bg-indigo-500 hover:bg-indigo-700 dark:hover:bg-indigo-600 text-white text-sm font-bold transition-colors shadow-lg shadow-indigo-500/20"
          >
        ...
        <div className="flex flex-col items-center justify-center py-16 rounded-2xl border border-gray-100 dark:border-white/[0.08] bg-gray-50/50 dark:bg-white/[0.02]">
          ...
          <button
            ...
            className="mt-4 text-xs text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 dark:hover:text-indigo-300 underline underline-offset-2 font-semibold"
          >
            Clear filters
          </button>
        </div>
